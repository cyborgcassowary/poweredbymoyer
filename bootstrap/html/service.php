...
<?php
  ...
  list($serviceRecords, $serviceMetaData) = getRecords(array(
    'tableName'   => 'service',
  ...
  $serviceRecord = @$serviceRecords[0]; // get first record
  if (!$serviceRecord) { dieWith404("Record not found!"); } // show error message if no record found
...
<title>Powered by Moyer | Service</title>
<meta name="description" content="We hope to provide you with the best services before and after the sale. Our trained technicians will provide you expert service on any equipment you need fixed. Suppling the best tools and service in the Doylestown area since 1926." />
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="service.php" class="currentpage">SERVICE</a></li>
...
<div class="container" id="maincontent"> 
  <div class="row">
    <div class="col-md-9" id="correctmargin">
      ...
      <?php echo $serviceRecord['content']; ?><br/>
