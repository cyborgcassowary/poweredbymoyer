...
<?php
  ...
  // load records from 'financing'
  list($financingRecords, $financingMetaData) = getRecords(array(
    'tableName'   => 'financing',
    'loadUploads' => true,
    'allowSearch' => false,
  ));
...
<title>Powered by Moyer | Financing</title>
<meta name="description" content="We offer financing on BOB-CAT and Husqvarna. Suppling the best tools and service in the Doylestown area since 1926." />
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="financing.php" class="currentpage">FINANCING</a></li>
...
<div class="container" id="maincontent"> 
  <div class="row">
    <div class="col-md-9" id="correctmargin">
      <h2 class="headline">FINANCING</h2>
      <?php foreach ($financingRecords as $record): ?>
      <strong><?php echo htmlencode($record['title']) ?></strong><br/>
      <?php echo $record['content']; ?><br/>
      
    <?php endforeach ?>

    <?php if (!$financingRecords): ?>
      No records were found!<br/><br/>
    <?php endif ?>
      <br />
      <br />
    * Financing details are subject to change at any time.
